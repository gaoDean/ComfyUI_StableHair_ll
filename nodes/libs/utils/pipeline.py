...
from ..ref_encoder.reference_unet import RefHairUnet
...
class StableHairPipeline(DiffusionPipeline, FromSingleFileMixin):
    ...
    def __init__(
            ...
            reference_encoder: RefHairUnet = None
    ):
        super().__init__()
    ...
    def prepare_condition(self, condition, device, dtype, do_classifier_free_guidance):
        ...
        if do_classifier_free_guidance:
            ...
            condition = torch.cat([condition_pad, condition]).to(device)
        return condition
    ...
    def __call__(
        ...
        reference_control_writer = ReferenceAttentionControl(self.reference_encoder, do_classifier_free_guidance=True,
        ...
        if isinstance(ref_image, str):
            ...
            ref_image_latents = self.images2latents(ref_image, latents_dtype)
